  ...
  return (
    <main className="bg-[#231D16] w-screen">
      ...
      <section className="w-[50%] lg:mx-96 md:mx-96 mx-10 lg:px-10 md:px-10">
        {[
          { label: "Creator Name", value: creatorName, setValue: setCreatorName, placeholder: "Enter your name" },
          { label: "Creator's Bio", value: bio, setValue: setBio, placeholder: "Enter your bio" },
          { label: "Creator's Socials", value: socials, setValue: setSocials, placeholder: "Enter your socials" },
